...
!(function (e, t) {
    ...
    return {
      ...
      getVelocity: function getVelocity(e) {
        var t = l,
          ...
          n = Ne();
        return (
          (!e && 0 !== e) || e === i || pd(e), s === l || c < n - l ? 0 : ((i + (o ? r : -r)) / ((o ? n : s) - t)) * 1e3
        );
      },
    };
  }
  ...
  function cc(e, t, r, n, o, i, a, s, l, c, u, f, p) {
    ...
    return (
      p &&
        h &&
        ((d = Mt(h)), p.seek(f), (g = Mt(h)), (p._caScrollDist = d[n.p] - g[n.p]), (e = (e / p._caScrollDist) * f)),
      p && p.seek(v),
      p ? e : Math.round(e)
    );
  }
        ...
        if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), vt)) {
          ...
          if (
            ...
            C &&
              ((C.vars.lazy = !1),
              C._initted ||
                (!1 !== C.vars.immediateRender && !1 !== S.immediateRender && C.duration() && C.render(0, !0, !0)),
            ...
            ie &&
              (!1 === ae ||
                ae === Ct ||
                (ae = !(!ae && ie.parentNode && ie.parentNode.style && 'flex' === eb(ie.parentNode).display) && St),
              (Te.pin = ie),
                ...
                if (ie && e && ht) ob(ScrollTrigger, 'scrollEnd', Gb);
                  ...
                  for (
                    La(x) && (x = x(Te)),
                      ...
                      O =
                        Math.max(P, cc(m || (y ? '100% 0' : h), y, d, he, Pe() + v, B, I, Te, g, _e, ye, h, pe)) ||
                        -0.001,
                      L = O - P || ((P -= 0.01) && 0.001),
                      v = 0,
                      T = _;
                  ...
                  f &&
                    ...
                    (G === Te.progress && !pe) ||
                      (C && !ve && C.totalProgress(G, !0), (Te.progress = (k - P) / L === G ? 0 : G)),
