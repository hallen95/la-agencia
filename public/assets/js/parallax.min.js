!(function (t, i, e) {
  ...
  (s.prototype.extend = function () {
    ...
    (s.prototype.transformSupport = function (s) {
      for (
        var n = i.createElement('div'), o = !1, r = null, a = !1, h = null, l = null, p = 0, c = this.vendors.length;
        c > p;
        p++
      )
        if (
    ...
    (s.prototype.enable = function () {
      this.enabled ||
        ...
        this.orientationSupport
          ...
          : ((this.cx = 0), (this.cy = 0), (this.portrait = !1), t.addEventListener('mousemove', this.onMouseMove)),
