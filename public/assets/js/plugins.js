...
!(function (t, e) {
  ...
  class xe {
    ...
    _getConfig(t) {
      return (
        ((t = { ...ke, ...('object' == typeof t ? t : {}) }).rootElement = o(t.rootElement)), r('backdrop', t, Le), t
      );
    }
    _append() {
      this._isAppended ||
  ...
  class je extends H {
    ...
    _getConfig(t) {
      return (
        (t = { ...Ie, ...F.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }), r('modal', t, Pe), t
      );
    }
    _showElement(t) {
    ...
    setElementContent(t, e) {
      if (null !== t)
        return s(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize && (e = Fe(e, this._config.allowList, this._config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
