...
!(function (t, e) {
  ...
  function yd(t, e, r, i) {
    ...
    return (
      ...
      ze[e] && 'transform' !== e
        ? ((n = We(t, i)), (n = 'transformOrigin' !== e ? n[e] : He(md(t, Ne)) + ' ' + n.zOrigin + 'px'))
  ...
  var se,
    ...
    er = function _renderCSSTransforms(t, e) {
      ...
      _ !== Ke && (y += 'perspective(' + _ + tr),
        (i || n) && (y += 'translate(' + i + '%, ' + n + '%) '),
        (!b && a === Ke && s === Ke && o === Ke) ||
          (y += o !== Ke || b ? 'translate3d(' + a + ', ' + s + ', ' + o + ') ' : 'translate(' + a + ', ' + s + tr),
        u !== Ze && (y += 'rotate(' + u + tr),
        h !== Ze && (y += 'rotateY(' + h + tr),
        l !== Ze && (y += 'rotateX(' + l + tr),
          ...
          if ('autoRound' !== f && ((s = e[f]), !ft[f] || !Qb(f, e, r, i, t, n)))
            if (
              ...
              if (
                ...
                if (
                  (m ||
                    (((g = t._gsap).renderTransform && !e.parseTransform) || We(t, e.parseTransform),
