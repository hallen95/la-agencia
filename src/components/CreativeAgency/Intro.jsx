            ...
            <div className="cont sec-lg-head">
              ...
              <h2 className="d-slideup wow">
                <span className="sideup-text">
                  <span className="up-text">We’re sharp brands creators</span>
                </span>
                <span className="sideup-text">
                  <span className="up-text">open for any new collabs</span>
                </span>
              </h2>
              <div className="row">
                <div className="col-lg-12">
                  ...
                  <div className="underline">
                    <Link href="/dark/page-about" className="mt-30 ls1 sub-title">
                      Read More{' '}
                      <i className="ml-5">
