        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="expr-box md-mb50">
              <h6 className="text-u fz-16 mb-40">
                Europe's Leading <br /> Architectural
              </h6>
              <div>
                <p className="fz-14 fw-600 line-height-1 mb-15">
                  Years <br /> Experience
                </p>
          ...
          <div className="col-lg-4 offset-lg-1">
            <div className="cont">
              <h3 className="text-u">
                Design With <span className="main-color">Community</span> <br /> In Mind.
              </h3>
              <p>
                Through a unique combination of engineering, construction and design disciplines and expertise, Concor
                delivers world className infrastructure.
              </p>
            </div>
          </div>
        </div>
