...
function ModalVideo({ videoId, channel, isOpen, onClose, autoplay }) {
  ...
  return isOpen ? (
    <div className="modal-video" tabIndex="-1" role="dialog" aria-label="video" onClick={onClose}>
      <div className="modal-video-body">
        <div className="modal-video-inner">
          <button className="modal-video-close-btn" aria-label="video" ref={closeBtn} onClick={onClose} />
